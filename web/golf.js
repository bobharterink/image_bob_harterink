...
function changedotSize(e) {
  window.player.setValue("golfcode21", "stepY", e.value);
}
window.changedotSize = changedotSize;
function changedotShift(e) {
  window.player.setValue("golfcode22", "stepX", e.value);
}
...
function changedotSize3(e) {
  window.player.setValue("golfcode22", "stepY", e.value);
}
...
function changedotColor2(e) {
  window.player.setValue("divide2", "b", e.value);
}
...
async function loadImageWithUrl(url) {
  ...
  image.onload = function () {
    ...
    player.setValue("uploadimg1", "imageName", url);
