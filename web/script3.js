document.addEventListener("DOMContentLoaded", function () {
  ...
  const logoImages = [
    {
      src: "http://127.0.0.1:5500/web/Door_Het_Oog1.png",
      color: "#ed1c40",
      secondaryColor: "#ffe6ea",
      hoverColor: "#D01937",
      favicon: "http://127.0.0.1:5500/web/favicon1.ico?v=3",
    },
    {
      src: "http://127.0.0.1:5500/web/Door_Het_Oog2.png",
      color: "#1c88ed",
      secondaryColor: "#d9edff",
      hoverColor: "#1872C7",
      favicon: "http://127.0.0.1:5500/web/favicon2.ico?v=2",
    },
    {
      src: "http://127.0.0.1:5500/web/Door_Het_Oog3.png",
      color: "#1ced6b",
      secondaryColor: "#e6ffef",
      hoverColor: "#1BD863",
      favicon: "http://127.0.0.1:5500/web/favicon3.ico?v=2",
    },
    {
      src: "http://127.0.0.1:5500/web/Door_Het_Oog4.png",
      color: "#ed1cae",
      secondaryColor: "#ffe6f7",
      hoverColor: "#BB178A",
      favicon: "http://127.0.0.1:5500/web/favicon4.ico?v=2",
    },
    {
      src: "http://127.0.0.1:5500/web/Door_Het_Oog5.png",
      color: "#edb71c",
      secondaryColor: "#fff8e6",
      hoverColor: "#E1AB16",
      favicon: "http://127.0.0.1:5500/web/favicon5.ico?v=2",
    },
  ];
